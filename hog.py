...
def max_scoring_num_rolls(dice=six_sided):
    ...
    list_ave = []
    while num_rolls <= 10:
        print(num_rolls , 'dice scores' , make_averaged(roll_dice , 1000) (num_rolls , dice) , 'on average')
        #list_ave.append(make_averaged(roll_dice , 1000) (num_rolls , dice) , nu)
        num_rolls += 1
    print(num_rolls - 1)
...
def run_experiments():
    ...
    if True: #Change to True to test catch_up_strategy
        print('catch_up_strategy win rate:', average_win_rate(catch_up_strategy))
...
def swap_strategy(score, opponent_score):
    ...
    5
    """
    if score < opponent_score and can_swap:
        return 0
    return BASELINE_NUM_ROLLS # Replace this statement
...
def final_strategy(score, opponent_score):
    ...
    """
    if score >= 90 and Free_Bacon >= 7:
        return 0
    elif mul(2 , score + 1) == opponent_score:
        return 10
    elif opponent_score < 50:
        return 2
    elif add(score + 1, opponent_score)%7 == 0:
        return BASELINE_NUM_ROLLS
    return 2 # Replace this statement

#my own rules
def catch_up_strategy(score, opponent_score):
    if score and opponent_score > Goal_Threashold:
